...
if (session_status() === PHP_SESSION_NONE) {
    ...
    session_set_cookie_params([
        ...
        "path" => "/sistema-gestion-institucional/", // Limitado solo al proyecto sistema-gestion-institucional
        "domain" => "",
...
function obtenerUsuarioActual()
{
    ...
    return [
        ...
        "modulos_permitidos" =>
            $_SESSION["usuario"]["modulos_permitidos"] ?? [],
    ];
}
 ...
 */
function requererAutenticacion(
    $redirigirA = "/sistema-gestion-institucional/pages/login/login.php",
) {
    if (!verificarUsuarioAutenticado()) {
