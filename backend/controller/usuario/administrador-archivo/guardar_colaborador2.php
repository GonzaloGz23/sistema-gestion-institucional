...
if($tipo == 'archivo') {
    $queryVerificar = "SELECT COUNT(*) FROM colaborador_carpetas WHERE id_archivo = :idCarpeta AND id_colaborador = :idUsuario";
...
if($tipo == 'archivo') {
    $stmtInsertar = $pdo->prepare("INSERT INTO colaborador_carpetas (nombre_colaborador, apellido_colaborador, id_colaborador, id_archivo) VALUES (:nombre, :apellido, :idUsuario, :idCarpeta)");
