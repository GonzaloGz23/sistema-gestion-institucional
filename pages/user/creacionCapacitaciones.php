                            ...
                            <div class="p-4">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select" id="tipoCapacitacion">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-select" id="categoriaGeneral">
                                            <option value="">Cargando categorías...</option>
                                        </select>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="categoriaEspecifica" class="form-label fw-bold">4. Categoría Específica (opcional)</label>
                                        <select class="form-select" id="categoriaEspecifica" disabled>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="lugar" placeholder="Solo si es modalidad presencial o mixto">
                                    </div>
                                </div>
                            </div>
                        </div>
