...
<main class="db-content" data-entity="<?php echo $usuarioActual->id_entidad; ?>">
    <div class="container-fluid mt-4">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEmpleado" data-action="crear">
        ...
        <p id="mensajeNoEmpleados" class="text-center text-muted d-none">No hay empleados cargados en el sistema.</p>
    ...
    <!-- Modal único para gestionar Empleados -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button id="modalEmpleadoConfirm" type="button" class="btn"></button>
                </div>
            </div>
        </div>
    </div>
...
<!-- Cargar los scripts -->
<script src="./js/empleados/empleados-data.js"></script>
<script src="./js/empleados/empleados-ui.js"></script>
