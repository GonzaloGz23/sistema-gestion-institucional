...
<form action="" id="resp_form">
    ...
    foreach ($preguntas as $preg) {
        echo "<div class='mb-3 pregunta-item' id='pregunta_{$preg['id_preguntas']}'>
                <div class='row d-flex align-items-center'>
                <div class='col-lg-10 col-md-10 col-sm-10'>
                
                <label class='text-uppercase'>
                    {$preg['orden']}. {$preg['texto']}
                   ";
       ...
       <div class="d-flex justify-content-between col-3 calificacion" id="estrellas">
            ...
            <label for="star2" data-value="2">2</label>s
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.eliminar-pregunta').forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    const preguntaDiv = document.getElementById('pregunta_' + id);
                    if (preguntaDiv) {
                        preguntaDiv.remove();
                    }
                });
            ...
            // Agregar pregunta (dinámico simple)
            document.getElementById('agregarPregunta').addEventListener('click', function() {
                const nuevaPregunta = document.createElement('div');
                nuevaPregunta.classList.add('mb-3');
                nuevaPregunta.innerHTML = `
            <label><strong>Nueva Pregunta</strong></label><br>
            <input type="text" class="form-control" placeholder="Texto de la pregunta"><br>
            ...
            <button type="button" class="btn btn-danger btn-sm eliminar-pregunta-nueva">Eliminar</button>
        `;
                document.getElementById('resp_form').appendChild(nuevaPregunta);

                // Botón eliminar para esta nueva
                nuevaPregunta.querySelector('.eliminar-pregunta-nueva').addEventListener('click', function() {
