...
<div class="db-content">
    <div class="container mb-4">
        <div class="row my-2">
            <h1 class="h2 mb-0">Gestión de formularios</h1>
        </div>
        <div class="contenedor-cards mt-4">
            <a href="./tipos_formularios.php"
            ...
            <a href="./crear_formulario.php"
                ...
                <div class="card-body d-flex flex-column justify-content-center gap-2 text-center h-100">
                    ...
                    <div>
                        <h6 class="mb-0">Creación</h6>
                    </div>
                </div>
            </a>
            <a href="./mis_formularios.php"
                class="card card-acceso card-border-primary rounded-4 text-decoration-none position-relative">
                <div class="card-body d-flex flex-column justify-content-center gap-2 text-center h-100">
                    <div>
                    ...
                    <div>
                        <h6 class="mb-0">Mis Formularios</h6>
                    </div>
                </div>
