            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-0">
                    ...
                    <ul class="nav nav-tabs nav-justified" id="capacitacionTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation" id="li-profesor-hide">
                            <button class="nav-link" id="profesores-tab" data-bs-toggle="tab" data-bs-target="#profesores" type="button" role="tab">
                                <i class="bi bi-book"></i> <span class="d-none d-md-inline">Profesores</span>
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                    ...
                    <div class="tab-content mt-3" id="capacitacionTabContent">
                        ...
                        <div class="tab-pane fade" id="profesores" role="tabpanel">
                            <div class="p-4">
                                <div class="row g-3">
                                    <div class=" form-prof row g-3">
                                    <div class="col-md-5">
                                        <label for="dni-profesor" class="form-label fw-bold">1. Numero de Documento</label>
                                        <input type="number" class="form-control" id="dni-profesor">
                                    </div>
                                    <div class="col-md-5">
                                        <label for="dni-profesor" class="form-label fw-bold ms-2">2. Genero</label>
                                        <select name="geero-profesor" class="form-select" id="genero-profesor">
                                    ...
                                    <div class="col-md-4">
                                        <label for="nombre-profesor" class="form-label fw-bold">3. Nombre del Profesor</label>
                                        <input type="text" class="form-control" id="nombre-profesor">
                                    </div>
                                    <div class="col-md-4">
                                        <label for="apellido-profesor" class="form-label fw-bold">4. Apellido Profesor</label>
                                        <input type="text" class="form-control" id="apellido-profesor">
                                    </div>
                                    <div class="col-md-4">
                                        <label for="telefono-profesor" class="form-label fw-bold">5. Telefono</label>
                                        <input type="number" class="form-control" id="telefono-profesor">
                                    </div>
                                    <div class="col-md-4">
                                        <label for="correo-profesor" class="form-label fw-bold">6. Correo</label>
                                        <input type="email" class="form-control" id="correo-profesor">
                                    </div>
                                </div>
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <span class="text-muted pe-1">Configurar los profesores que dictaran en la cursada.</span>
                                        <button type="button" class="btn btn-sm btn-outline-primary" onclick="agregarProfesor()">
                                            <i class="bi bi-plus"></i> Agregar Profesor
                                        </button>
                                    </div>

                                    <div class="col-12">
                                        <h6 class="fw-bold mt-3 mb-3">Listado de Profesores</h6>
                                        <div id="listadoContainer">
                                            <!-- Los horarios se insertarán aquí dinámicamente -->
                                             <table  class="table">
                                                ...
                                                <tbody id="list-profesores"></tbody>
                                            </table>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card h-100">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <small class="text-muted">Formatos aceptados: JPG, PNG, WEBP. Tamaño máximo: 2MB</small>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="mb-3">
                                                            <label class="form-label fw-semibold">Destacar:</label>
                                                            <div class="d-grid gap-2">
                                                                <button class="btn btn-warning btn-sm" onclick="cambiarEstadoDestacado()" id="btnDestacar">
                                                                    <i class="bi bi-star"></i> <span id="btnDestacarTexto">Destacar</span>
                                                                </button>
                                                                <small class="text-muted">Marca la capacitación como destacada en el sitio público</small>
                                                            </div>
                                                        </div>
